...
\subsection{Fore signal (Předvěst)}
In Article 101 of the regulation, they describe fore signal in czech called (\("\)předvěst\("\)). This signal is dependent on main signal.
Typically, this signal adds another notification for the train driver before the driver could see the main signal.
%todo dokončit a překontrolovat



\subsection{Single-Light Signals}
In this section we will describe single-light signals and their characteristics described in the railway signaling regulation SŽ D1 Část První.
It is important to mention that described signaling systems on railway tracks are not equipped with the European Train Control System.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.1\linewidth]{myimgs/green.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.1\linewidth]{myimgs/one_yellow_blinking.pdf}
...
% todo from here
%A notable feature of these signals is their systematic progression. The regulation establishes a clear hierarchy of speed indications, beginning with "Očekávejte rychlost 40 km/h" (40–50 km/h) and extending to "Očekávejte rychlost 120 km/h" (120 km/h), the latter uniquely identified by a rapidly flashing green light paired with a yellow "12" numeral. This use of a numeral to denote tens of kilometers per hour introduces a layer of precision that enhances clarity, particularly at higher speeds where reaction times are shorter and accuracy is paramount.
%
%**[Space reserved for Figure: Obrázek 104 - Návěst Očekávejte rychlost 120 km/h (rapidly flashing green light with yellow "12")]**
%
%The spatial requirements associated with these signals also warrant attention. The regulation stipulates that the next main signal must be located at least at the braking distance for speed-restrictive indications, ensuring drivers have adequate time to adjust. This condition underscores a balance between operational efficiency and safety, a recurring theme throughout the document. Conversely, the "Volno" signal, which implies no immediate speed restriction, allows greater flexibility in signal placement, particularly on high-speed sections.
%
%This section emphasizes the practical implications of these technical specifications. Single-light signals are not merely abstract commands; they govern how train drivers navigate the railway network, responding to real-time conditions while anticipating future states. The regulation’s emphasis on clarity—achieved through distinct colors and flashing patterns—minimizes ambiguity, a vital consideration in the high-stakes realm of railway operations. While implementation details such as coding a signal system are beyond the scope, the technical elegance of this design stands out, where a single light efficiently conveys both permission and foresight.
\newpage
